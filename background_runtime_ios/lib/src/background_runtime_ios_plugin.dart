...
/// iOS implementation of [BackgroundRuntimePlatform].
///
/// Communicates with native Swift code via method and event channels.
final class BackgroundRuntimeIosPlugin extends BackgroundRuntimePlatform {
