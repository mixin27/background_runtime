...
public class BackgroundRuntimeIosPlugin: NSObject, FlutterPlugin {
    ...
    public static func register(with registrar: FlutterPluginRegistrar) {
        ...
        instance.downloadManager.setupBackgroundSession()
    ...
    private func handleInitialize(_ call: FlutterMethodCall, _ result: @escaping FlutterResult) {
        ...
        let enableDownloads = configMap["enableDownloads"] as? Bool ?? true
...
extension BackgroundRuntimeIosPlugin: FlutterStreamHandler {
...
extension BackgroundRuntimeIosPlugin {
    public func application(_ application: UIApplication, handleEventsForBackgroundURLSession identifier: String, completionHandler: @escaping () -> Void) -> Bool {
        if identifier == "dev.mixin27.background_runtime.download" {
            ...
            downloadManager.setupBackgroundSession()
            return true
        }
        return false
    }
