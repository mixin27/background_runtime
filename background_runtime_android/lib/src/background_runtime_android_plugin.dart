...
/// Android implementation of [BackgroundRuntimePlatform].
///
/// Communicates with native Kotlin code via method and event channels.
final class BackgroundRuntimeAndroidPlugin extends BackgroundRuntimePlatform {
  ...
  BackgroundRuntimeAndroidPlugin({
